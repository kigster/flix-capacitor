...
void FileSystem::nextFileInList(FileList *fileList, char* fullPath,
		direction dir) {
...
void FileSystem::saveDirectory(FileList *fileList, File dir, int level,
		char *match) {
...
FileList *FileSystem::findFilesMatchingExtension(char *folder,
		char *extension) {
